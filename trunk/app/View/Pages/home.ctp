...
<!--            <li><div class="navHome"> <?php // echo $this->Html->image("videos.png", array("class" => "icon", "alt" => "health tips and videos", 'url' => array('controller' => 'videos'))); ?><p>Videos</p> </div></li>-->
        ...
        /* layouts for member users, the members is able to manage their personal info, the following functions is under structuring :) */ 
            ...
            <li><div class="navHome"> <?php echo $this->Html->image("medicalRecord.png", array("class" => "icon", "alt" => "Manage Your Medical Records", 'url' => array('controller' => 'uploads'))); ?> <p>Upload Medical Record</p></div></li>
            ...
            <li><div class="navHome"> <?php echo $this->Html->image("event.png", array("class" => "icon", "alt" => "remainders", 'url' => array('controller' => 'invitations','action' => "eventParticipation"))); ?> <p>FSGA Events</p></div></li>
